            ...
            <div class="row">
                <div class="col-md-8 ">
                    <div class="room_detail_1 border">
                        ...
                        $sql = "select * from room_detail inner join room on room.id = room_detail.room_type where room.id=$id_room";
                            ...
                            <div class="room_detail_2">
                                ...
                                <div class="row">
                                    <div class="col-md-4 text-center">
                                        <h2 class="room_don"><?php echo $row['name']; ?></h2>
                                    </div>
                                    <div class="col-md-3 offset-md-5 ">
                                        <p class="room_gia"> <span><?php echo $row['price']; ?>$</span> / night</p>
                                    </div>
                                </div>
                                <hr>
                                <div class="book_room">
                        ...
                        <div class="img_similar">
                            <div class="img_si_1">
                                <a href="#">
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-md-6">
                                            <h5 class="room_don text-dark">Double Room</h5>
                                        </div>
                                        <div class="col-md-6 text-end ">
                                            <p class="room_gia"> <span>130$</span> / night</p>
                                        </div>
                                    </div>
                                </a>
                                <hr>
                        ...
                        <div class="img_similar">
                            <div class="img_si_1">
                                <a href="">
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-md-6">
                                            <h5 class="room_don text-dark">Deluxe Room</h5>
                                        </div>
                                        <div class="col-md-6 text-end ">
